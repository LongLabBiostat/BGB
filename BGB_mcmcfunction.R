...
## new 
BGB <- function(dt,T,L,p,n,X,trials,nu_1,nu_2,nu_3,nu_4,Sigma,Q,eta,eps,rho_temp,tau_temp,omega_temp,inv_omega_temp,w_temp,z_temp,alpha_temp,m_temp,tauz_temp,xiz_temp,start,end,mu){
